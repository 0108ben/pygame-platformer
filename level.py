...
class Level:
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == '1':
                    ...
                    sprite = StaticTile(tile_size, x, y+36, hat_surface)
    ...
    def run(self):
        ...
        self.constraint_sprites.update(self.world_shift)  # create enemy barriers
        self.enemy_collision_reverse()  # turn the enemy when it hits a barrier
